...
class KeyValueTableExampleApp extends StatefulWidget {
  const KeyValueTableExampleApp({super.key});

  @override
  State<KeyValueTableExampleApp> createState() =>
      _KeyValueTableExampleAppState();
}

class _KeyValueTableExampleAppState extends State<KeyValueTableExampleApp> {
